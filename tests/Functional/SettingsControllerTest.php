...
/**
 * Teste la page de paramètres et la mise à jour de la photo de profil :
...
final class SettingsControllerTest extends AppWebTestCase
{
    ...
    /**
     * Récupère le token CSRF du formulaire de photo rendu sur la page de paramètres.
     *
     * @return string
     */
    ...
    public function testUpdatePictureStoresFileAndUpdatesUser(): void
    {
        ...
        // la page de paramètres affiche la confirmation et la navbar rend la photo
